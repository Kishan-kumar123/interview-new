        ...
        {!report && (
          <div className="bg-slate-900/10 border border-slate-850 rounded-2xl p-6">
            <form onSubmit={handleAnalyzeResume} className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  {!selectedFile ? (
                    ...
                    >
                      ...
                      />
                      <div className="bg-slate-900 duration-200 p-4 rounded-full border border-slate-800 text-amber-500">
              ...
              {errorMessage && (
                <div className="bg-red-950/40 border border-red-800 text-red-300 p-4 rounded-xl text-xs">
                  {errorMessage}
                </div>
              )}

              <div className="pt-4 border-t border-slate-850/65 flex justify-between items-center text-xs text-slate-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-slate-900/10 border border-slate-850 p-5 rounded-2xl space-y-4">
                ...
                <div className="flex flex-wrap gap-1.5 pt-2">
                  {report.detectedKeywords && report.detectedKeywords.map((tag: string, idx: number) => (
              ...
              <div className="bg-slate-900/10 border border-slate-850 p-5 rounded-2xl space-y-4">
                ...
                <div className="flex flex-wrap gap-1.5 pt-2">
                  {report.missingKeywords && report.missingKeywords.map((tag: string, idx: number) => (
...
export type ResumeAnalyzerType = any;
