...
export const api = {
  ...
  createCodingQuestion: async (payload) => {
  ...
  generateDynamicAptitudeQuestions: async (category, count = 5) => {
  ...
  submitAptitudeScore: async (payload) => {
  ...
  createAptitudeQuestion: async (payload) => {
  ...
  generatePrepQuestions: async (company) => {
  ...
  createInterviewQuestion: async (payload) => {
  ...
  joinHackathon: async (id, teamName) => {
  ...
  submitHackathon: async (id, teamName, submissionCode) => {
  ...
  approveCertificate: async (id, status) => {
  ...
  simulateInterviewTurn: async (payload) => {
  ...
  awardInterviewCertificate: async (payload) => {
  ...
  registerHackathonEvent: async (payload) => {
  ...
  submitHackathonAI: async (payload) => {
  ...
  getPublicStats: async () => {
    ...
    if (!res.ok) throw new Error('Failed to load public stats');
    return res.json();
  }
};
