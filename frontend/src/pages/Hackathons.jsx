...
export const Hackathons = () => {
  ...
  const handleRegisterEvent = async (id, type) => {
    try {
  ...
  const handleAISubmission = async (hackathonId) => {
  ...
  const getContestProblems = (contestId) => {
    if (contestId === 'ct-1') {
      return [
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                                <div className="bg-emerald-950/10 border border-emerald-950/30 p-4 rounded-xl space-y-2">
                                  ...
                                  <ul className="space-y-1.5">
                                    {(reports[h.id].strengths || []).map((s, idx) => (
                                ...
                                <div className="bg-amber-950/10 border border-amber-950/30 p-4 rounded-xl space-y-2">
                                  ...
                                  <ul className="space-y-1.5">
                                    {(reports[h.id].improvements || []).map((im, idx) => (
                                      <li key={idx} className="text-xs text-slate-400 flex items-start gap-1.5">
                        ...
                        >
                          ...
                          <td className="py-3.5 px-4">
                            <div className="flex flex-wrap gap-1 max-w-xs">
                              {(player.badges || ["Fast Starter"]).map((b, index) => (
                                <span 
                                  key={index} 
