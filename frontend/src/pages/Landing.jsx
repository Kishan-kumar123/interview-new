...
export const Landing = () => {
      ...
      try {
        ...
        if (res && active) {
          setLiveStats({
            ...
            totalInterviews: res.totalInterviews,
            totalUsers: res.totalUsers,
            atsImprovement: res.atsImprovement
          });
        }
      } catch (err) {
  ...
  const stats = [
    { value: liveStats.totalSolved, label: "Total Challenges Solved" },
    { value: liveStats.totalInterviews, label: "AI Mock Sessions Completed" },
    { value: liveStats.totalUsers, label: "Daily Active Students" },
    { value: liveStats.atsImprovement, label: "ATS Improvement Index" }
  ];
